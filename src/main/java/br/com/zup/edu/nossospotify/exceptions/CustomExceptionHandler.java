package br.com.zup.edu.nossospotify.exceptions;
...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<ErroPadronizado> handleParticipanteNaoEncontrado(ParticipanteNaoEncontradoException ex) {
